  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <img src="/logo.png" alt="BuildWithMushfiq Logo" className="w-8 h-8 rounded-lg group-hover:rotate-6 transition-transform shadow-lg shadow-primary/20 object-cover" />
